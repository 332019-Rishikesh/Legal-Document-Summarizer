...
def calculate_sentence_scores(text, large_text_threshold=50000):
    ...
    if lenT > large_text_threshold and lenT < 500000:
        select_len = int(len(sent_tokens) * 0.03)

    elif lenT > 500000:
        select_len = int(len(sent_tokens) * 0.04)
...
def abstractive(sentence_scores):
    ...
    model_path = "C:\\Users\\RITVIK\\OneDrive\\Desktop\\DocumentSummarization\\distilbart-cnn-12-6"
